...
class SmartRateLimiter:
    def __init__(
        ...
        method_credits: MethodCredit | None = None,
    ) -> None:
        ...
        if self.max_credits:
            ...
            raise ValueError(
                "Missing parameter: either 'max_count' or 'max_credits' (and 'method_credits') is needed"
            )
        ...
        def wrapper(self_: GotSmartRateLimiter, *args: Any, **kwargs: Any) -> Any:
            ...
            if smart_rate_limiter:
                ...
                if isinstance(rate_limiter, CreditRateLimiter) and smart_rate_limiter.method_credits:
                    ...
                    return throughput(rate_limiter, request_credits=request_credits)(func)(
                        self_, *args, **kwargs
                    )
