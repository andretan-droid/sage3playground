...
class _BashSession:
    ...
    async def run(self, command: str):
        ...
        # Background commands need wrapping so the sentinel still appears.
        ...
        try:
            async with asyncio.timeout(self._timeout):
                while True:
                    ...
                    # Reading the stream directly would block on EOF; peek the
                    # internal buffer instead so we can detect the sentinel.
